...
parser.add_argument('-i', '--npz_tr_path', type=str, default='/home/amit/experiment_comparing_model/AquaSAM/dataset/npz_output/train')
parser.add_argument('--task_name', type=str, default='SAM-ViT-L-Custom')
parser.add_argument('--model_type', type=str, default='vit_l')
parser.add_argument('--checkpoint', type=str, default='/home/amit/experiment_comparing_model/SAM_DEEPFISH_PTH/sam_l.pt')
...
for epoch in range(num_epochs):
    ...
    for step, (image_embedding, gt2D, boxes) in enumerate(tqdm(train_dataloader)):
        ...
        loss_seg = seg_loss(low_res_masks, gt2D.to(device).float())
